...
def delivered_trip_to_domain(orm: DeliveredTripORM) -> DeliveredTrip:
    return DeliveredTrip(
        ...
        trip_date=orm.trip_date,
        original_trip_date=orm.original_trip_date,
        original_cont_number=orm.original_cont_number,
        note=orm.note,
        created_at=orm.created_at,
        updated_at=orm.updated_at,
    )
...
def delivered_trip_to_orm(
    ...
    orm.original_trip_date = w.original_trip_date
    orm.original_cont_number = w.original_cont_number
    orm.note = w.note
    return orm
