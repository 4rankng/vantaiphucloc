...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "pivot_columns_json", sa.String(), nullable=False, server_default="[]"
        ),
    ...
    op.create_index(
        op.f("ix_mapping_profiles_profile_name"),
        "mapping_profiles",
        ["profile_name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_mapping_profiles_header_signature"),
        "mapping_profiles",
        ["header_signature"],
        unique=False,
    )
...
def downgrade() -> None:
    op.drop_index(
        op.f("ix_mapping_profiles_header_signature"), table_name="mapping_profiles"
    )
    op.drop_index(
        op.f("ix_mapping_profiles_profile_name"), table_name="mapping_profiles"
    )
