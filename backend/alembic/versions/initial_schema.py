...
def upgrade() -> None:
    ...
    op.create_table('driver_salary_configs',
        sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index('ix_driver_salary_configs_driver_effective_desc', 'driver_salary_configs', ['driver_id', 'effective_from'], unique=False)
    op.create_index(op.f('ix_driver_salary_configs_driver_id'), 'driver_salary_configs', ['driver_id'], unique=False)
    op.create_index(op.f('ix_driver_salary_configs_id'), 'driver_salary_configs', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_booked_trips_client_id'), 'booked_trips', ['client_id'], unique=False)
    op.create_index('ix_booked_trips_client_id_trip_date', 'booked_trips', ['client_id', 'trip_date'], unique=False)
    op.create_index(op.f('ix_booked_trips_cont_number'), 'booked_trips', ['cont_number'], unique=False)
    op.create_index(op.f('ix_booked_trips_dropoff_location_id'), 'booked_trips', ['dropoff_location_id'], unique=False)
    op.create_index(op.f('ix_booked_trips_id'), 'booked_trips', ['id'], unique=False)
    op.create_index(op.f('ix_booked_trips_pickup_location_id'), 'booked_trips', ['pickup_location_id'], unique=False)
    op.create_index('ix_booked_trips_trip_date', 'booked_trips', ['trip_date'], unique=False)

    op.create_table('delivered_trips',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('client_id', sa.Integer(), nullable=False),
        sa.Column('pickup_location_id', sa.Integer(), nullable=False),
        sa.Column('dropoff_location_id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_delivered_trips_booked_trip_id'), 'delivered_trips', ['booked_trip_id'], unique=False)
    op.create_index(op.f('ix_delivered_trips_client_id'), 'delivered_trips', ['client_id'], unique=False)
    op.create_index(op.f('ix_delivered_trips_cont_number'), 'delivered_trips', ['cont_number'], unique=False)
    op.create_index('ix_delivered_trips_created_at', 'delivered_trips', ['created_at'], unique=False)
    op.create_index(op.f('ix_delivered_trips_driver_id'), 'delivered_trips', ['driver_id'], unique=False)
    op.create_index(op.f('ix_delivered_trips_dropoff_location_id'), 'delivered_trips', ['dropoff_location_id'], unique=False)
    op.create_index(op.f('ix_delivered_trips_id'), 'delivered_trips', ['id'], unique=False)
    op.create_index(op.f('ix_delivered_trips_pickup_location_id'), 'delivered_trips', ['pickup_location_id'], unique=False)
    op.create_index('ix_delivered_trips_vendor_id', 'delivered_trips', ['vendor_id'], unique=False)
    ...
    op.create_table('route_pricings',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('client_id', sa.Integer(), nullable=False),
        sa.Column('pickup_location_id', sa.Integer(), nullable=False),
        sa.Column('dropoff_location_id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_route_pricings_work_type'), 'route_pricings', ['work_type'], unique=False)
    ...
    op.create_table('vendor_route_pricings',
        sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_vehicle_drivers_driver_id'), 'vehicle_drivers', ['driver_id'], unique=False)
    op.create_index(op.f('ix_vehicle_drivers_id'), 'vehicle_drivers', ['id'], unique=False)
    op.create_index(op.f('ix_vehicle_drivers_vehicle_id'), 'vehicle_drivers', ['vehicle_id'], unique=False)
    ...
    op.create_index('ix_vehicle_expenses_category_date', 'vehicle_expenses', ['category', 'expense_date'], unique=False)
    ...
    op.create_index('ix_vehicle_expenses_vehicle_date', 'vehicle_expenses', ['vehicle_id', 'expense_date'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_vehicle_expenses_expense_date'), table_name='vehicle_expenses')
    ...
    op.drop_index(op.f('ix_vendor_route_pricings_work_type'), table_name='vendor_route_pricings')
    op.drop_index(op.f('ix_vendor_route_pricings_dropoff_location_id'), table_name='vendor_route_pricings')
    op.drop_index(op.f('ix_vendor_route_pricings_pickup_location_id'), table_name='vendor_route_pricings')
    op.drop_index(op.f('ix_vendor_route_pricings_vendor_id'), table_name='vendor_route_pricings')
    op.drop_index(op.f('ix_vendor_route_pricings_id'), table_name='vendor_route_pricings')
    op.drop_table('vendor_route_pricings')

    op.drop_index(op.f('ix_route_pricings_work_type'), table_name='route_pricings')
    op.drop_index(op.f('ix_route_pricings_dropoff_location_id'), table_name='route_pricings')
    op.drop_index(op.f('ix_route_pricings_pickup_location_id'), table_name='route_pricings')
    ...
    op.drop_index(op.f('ix_delivered_trips_pickup_location_id'), table_name='delivered_trips')
    op.drop_index(op.f('ix_delivered_trips_id'), table_name='delivered_trips')
    op.drop_index(op.f('ix_delivered_trips_dropoff_location_id'), table_name='delivered_trips')
    ...
    op.drop_index(op.f('ix_delivered_trips_booked_trip_id'), table_name='delivered_trips')
    ...
    op.drop_index(op.f('ix_booked_trips_dropoff_location_id'), table_name='booked_trips')
    ...
    op.drop_index(op.f('ix_driver_salary_configs_id'), table_name='driver_salary_configs')
    op.drop_index(op.f('ix_driver_salary_configs_driver_id'), table_name='driver_salary_configs')
    op.drop_index('ix_driver_salary_configs_driver_effective_desc', table_name='driver_salary_configs')
