...
Revision ID: 07db8d7b44fb
Revises: 
Create Date: 2026-05-23 12:01:49.065517
...
def upgrade() -> None:
    ...
    op.create_index('ix_booked_trips_matched', 'booked_trips', ['matched'], unique=False)
    ...
    op.create_index('ix_delivered_trips_matched', 'delivered_trips', ['matched'], unique=False)
