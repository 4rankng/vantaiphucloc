...
def upgrade() -> None:
    ...
    op.drop_constraint(
        "vehicle_expenses_created_by_fkey", "vehicle_expenses", type_="foreignkey"
    )
    op.create_foreign_key(
        "vehicle_expenses_created_by_fkey",
        "vehicle_expenses",
        "users",
        ["created_by"],
        ["id"],
    ...
    op.drop_constraint(
        "location_aliases_created_by_id_fkey", "location_aliases", type_="foreignkey"
    )
    op.create_foreign_key(
        "location_aliases_created_by_id_fkey",
        "location_aliases",
        "users",
        ["created_by_id"],
        ["id"],
    ...
    op.drop_constraint(
        "delivered_trips_driver_id_fkey", "delivered_trips", type_="foreignkey"
    )
    op.create_foreign_key(
        "delivered_trips_driver_id_fkey",
        "delivered_trips",
        "users",
        ["driver_id"],
        ["id"],
    ...
    op.drop_constraint(
        "delivered_trips_vendor_id_fkey", "delivered_trips", type_="foreignkey"
    )
    op.create_foreign_key(
        "delivered_trips_vendor_id_fkey",
        "delivered_trips",
        "vendors",
        ["vendor_id"],
        ["id"],
    ...
    op.drop_constraint(
        "driver_salary_configs_created_by_fkey",
    ...
    op.drop_constraint(
        "driver_salaries_created_by_fkey", "driver_salaries", type_="foreignkey"
    )
    op.create_foreign_key(
        "driver_salaries_created_by_fkey",
        "driver_salaries",
        "users",
        ["created_by"],
        ["id"],
