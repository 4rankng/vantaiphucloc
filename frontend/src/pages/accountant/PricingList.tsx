      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSubmit} disabled={!form.clientId || !form.route} className="flex-1" style={{ background: 'var(--theme-brand-primary)', color: 'var(--theme-text-on-brand)' }}>{editing ? 'Cập nhật' : 'Xác nhận'}</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
