...
import { type Column } from '@/components/shared/data-display/DataTable'
      ...
      render: (t) => {
          ...
          return (
            <button
              ...
              onMouseEnter={e => {
                ...
                el.style.color = 'var(--theme-status-error)'
        ...
        return (
          <button
            ...
            onMouseEnter={e => {
              const el = e.currentTarget
              el.style.color = 'var(--theme-status-warning)'
          ...
          >
            {opts.isUnmatchPending && opts.unmatchVariables === t.id
              ? <Loader2 className="h-4 w-4 animate-spin" style={{ color: 'var(--theme-status-warning)' }} />
