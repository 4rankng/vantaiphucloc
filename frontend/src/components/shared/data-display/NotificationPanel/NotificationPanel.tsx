      ...
      >
        ...
        >
          <div className="flex items-center gap-2">
            ...
            {unread > 0 && (
              <span className="text-xs font-bold px-1.5 py-0.5 rounded-full min-w-[20px] text-center"                 style={{ background: 'var(--theme-status-error)', color: 'var(--theme-text-on-brand)' }}>
                {unread}
              </span>
            )}
          </div>
