...
function resolveMobileTitle(pathname: string): string {
  const TITLES: Record<string, string> = {
    ...
    '/superadmin/accounts': 'Tài khoản',
    '/superadmin/clients': 'Chủ hàng',
    '/superadmin/transporters': 'Vận tải',
    '/superadmin/doi-soat': 'Đối soát',
    '/superadmin/expenses': 'Chi phí xe',
    '/superadmin/salary': 'Lương',
    '/superadmin/pnl': 'Tổng hợp',
    '/superadmin/locations': 'Địa điểm',
    '/superadmin/settings/ky-luong': 'Kỳ lương',
    '/superadmin/settings/cuoc-tuyen': 'Bảng giá cước',
    '/superadmin/settings/cuoc-tra-xe-ngoai': 'Bảng phí thuê xe',
    '/superadmin/settings/tac-nghiep': 'Loại tác nghiệp',
