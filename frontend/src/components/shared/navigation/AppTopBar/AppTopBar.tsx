...
import { NotificationPanel } from '@/components/shared/data-display/NotificationPanel/NotificationPanel'
import { useUnreadCount } from '@/components/shared/data-display/NotificationPanel/useUnreadCount'
import { UserDropdown } from '@/components/shared/overlays/ProfileDialog'
...
const DARK = {
  ...
  titleColor: 'var(--theme-text-on-brand)',
