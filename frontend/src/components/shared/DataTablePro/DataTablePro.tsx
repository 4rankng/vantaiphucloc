                ...
                >
                  {col.sortable ? (
                    <button
                      ...
                      style={sortKey === col.key ? { color: 'var(--theme-text-primary)', fontWeight: 600 } : { color: 'var(--theme-text-secondary)' }}
                    >
                      {col.header}
                      {sortKey === col.key ? (
                        sortDir === 'asc' ? (
                          <ChevronUp className="h-4 w-4" style={{ color: 'var(--theme-brand-primary)' }} />
                        ) : (
