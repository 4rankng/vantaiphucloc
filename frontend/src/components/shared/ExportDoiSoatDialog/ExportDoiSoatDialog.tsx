      ...
      >
        ...
        >
          ...
          <button
            ...
            style={{ background: canConfirm ? '#059669' : '#d1d5db' }}
            onMouseEnter={e => { if (canConfirm) (e.currentTarget as HTMLButtonElement).style.background = '#047857' }}
            onMouseLeave={e => { if (canConfirm) (e.currentTarget as HTMLButtonElement).style.background = '#059669' }}
          >
            Xuất file
          </button>
        </div>
