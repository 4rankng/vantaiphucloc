    ...
    <>
      {parts.map((part, i) =>
        part.startsWith('**') && part.endsWith('**') ? (
          <strong key={i} style={{ fontWeight: 700, color: 'var(--theme-text-primary)' }}>
            {part.slice(2, -2)}
          </strong>
        ) : (
    ...
    <div className="flex flex-wrap gap-1.5 mt-1">
      {chips.map(({ label, value }) => (
        <span
          ...
          style={{ background: 'rgba(99,102,241,0.1)', color: 'var(--theme-ai-accent-dark)' }}
        >
          <span style={{ color: 'var(--theme-ai-accent-light)', fontWeight: 500 }}>{label}:</span>
...
const confidenceMap: Record<string, { label: string; color: string; bg: string }> = {
  high:   { label: 'Cao',        color: 'var(--theme-status-success)', bg: 'rgba(5,150,105,0.1)'  },
  medium: { label: 'Trung bình', color: 'var(--theme-status-warning)', bg: 'rgba(217,119,6,0.1)'  },
  low:    { label: 'Thấp',       color: 'var(--theme-status-error)', bg: 'rgba(220,38,38,0.1)'  },
}
        ...
        <div className="px-5 py-4" style={{ background: 'var(--theme-bg-secondary)', minHeight: 120 }}>
              ...
              <div className="flex gap-1.5">
                {[0, 0.15, 0.3].map((delay, i) => (
                  <div
                    ...
                    style={{
                      background: 'linear-gradient(135deg,var(--theme-ai-accent-light),var(--theme-ai-accent-light))',
          ...
          {error && dataReady && !isPending && (
            <div className="flex flex-col items-center justify-center py-6 gap-2">
              <p className="text-sm text-center" style={{ color: 'var(--theme-status-error)', margin: 0 }}>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2">
                <span
                  ...
                  style={{ background: 'rgba(245,158,11,0.1)', color: 'var(--theme-status-warning)' }}
                >
              ...
              {diffFields.map(({ label, delivered, booked }) => (
                ...
                >
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1px 1fr' }}>
                    ...
                    <div
                      ...
                      style={{
                        ...
                        outline: syncChoice === 'delivered' ? '2px solid var(--theme-ai-accent)' : 'none',
                        outlineOffset: -2,
                      }}
                    >
                    ...
                    <div
                      ...
                      style={{
                        ...
                        outline: syncChoice === 'booked' ? '2px solid var(--theme-ai-accent)' : 'none',
                        outlineOffset: -2,
                      }}
                    >
                  ...
                  >
                    <span className="text-[11px]" style={{ color: 'var(--theme-text-muted)' }}>Kết quả:</span>
                    <span className="text-[13px] font-semibold" style={{ color: syncChoice ? 'var(--theme-ai-accent)' : 'var(--theme-border-default)' }}>
              ...
              {hasMatch ? (
                ...
                >
                  <div className="flex items-center gap-2 flex-wrap">
                    <span className="text-xs font-bold tracking-wide uppercase" style={{ color: 'var(--theme-ai-accent)' }}>
                      Chuyến đề xuất
                    </span>
                    {confidence && (
                      <span
                  ...
                  <p className="text-sm leading-relaxed m-0 mt-2" style={{ color: 'var(--theme-text-secondary)' }}>
                    {done
