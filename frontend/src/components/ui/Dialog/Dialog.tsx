...
>(({ className, children, hideCloseButton, style, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      ref={ref}
      className={cn(
        "relative w-full max-w-lg grid gap-4 p-6 shadow-xl duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 rounded-xl overflow-y-auto max-h-[85dvh]",
        className
      )}
      style={{
