...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Separator ref={ref} className={cn("-mx-1 my-1 h-px bg-[var(--theme-bg-tertiary)]", className)} {...props} />
))
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label ref={ref} className={cn("px-2 py-1.5 text-sm font-semibold text-[var(--theme-text-primary)]", inset && "pl-8", className)} {...props} />
))
