...
const PREVIEW_COLS = ['Chủ hàng', 'Điểm đi', 'Điểm đến', 'F20', 'F40', 'E20', 'E40', 'Tác nghiệp'] as const
      ...
      previewMut.mutate(f, {
        onSuccess: (data) => {
          ...
          setStats({
            ...
            unmatchedClient: data.stats.unmatchedClient,
        ...
        <div className="flex-1 overflow-auto px-1">
            ...
            <div className="space-y-4">
              {file ? (
                ...
                >
                  ...
                  <p className="text-[11px] m-0 mt-1" style={{ color: 'var(--ink-3)' }}>.xlsx — Cần có cột: CHỦ HÀNG, ĐIỂM ĐI, ĐIỂM ĐẾN, giá cước</p>
                </div>
              )}
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 flex-wrap text-[12px]">
                ...
                {(stats?.unmatchedClient ?? 0) > 0 && (
                  <span className="rounded-full px-2 py-0.5" style={{ background: 'var(--warning-soft)', color: 'var(--warning)' }}>{stats!.unmatchedClient} chủ hàng chưa khớp</span>
                )}
              </div>
                    ...
                    {rows.map((r, i) => {
                      ...
                      return (
                        <tr key={i} style={rowBg ? { background: rowBg } : undefined}>
                          ...
                          <td>
                            <span className="text-[12.5px]" style={{ color: 'var(--ink-2)' }}>{r.clientRaw}</span>
          ...
          {step === 'done' && (
            <div className="flex flex-col items-center text-center py-4">
              ...
              <h3 className="m-0 type-h2" style={{ color: 'var(--ink)' }}>Nhập dữ liệu thành công</h3>
              <div className="grid grid-cols-5 gap-3 w-full mt-4">
                <div className="p-2.5 rounded-lg" style={{ border: '1px solid var(--line)', background: 'var(--surface-2)' }}>
                  ...
                  <p className="type-caption m-0 mt-0.5" style={{ color: 'var(--ink-3)' }}>Cước tuyến mới</p>
                </div>
                <div className="p-2.5 rounded-lg" style={{ border: '1px solid var(--line)', background: 'var(--surface-2)' }}>
                ...
                <div className="p-2.5 rounded-lg" style={{ border: '1px solid var(--line)', background: 'var(--surface-2)' }}>
                  <p className="type-display m-0 tabular-nums" style={{ color: 'var(--warning)' }}>{commitMut.data?.createdClients ?? 0}</p>
                  <p className="type-caption m-0 mt-0.5" style={{ color: 'var(--ink-3)' }}>Chủ hàng mới</p>
                </div>
                <div className="p-2.5 rounded-lg" style={{ border: '1px solid var(--line)', background: 'var(--surface-2)' }}>
